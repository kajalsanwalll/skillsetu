      ...
      <div className="relative z-10 min-h-screen grid lg:grid-cols-2">
        ...
        <section className="hidden lg:flex flex-col justify-between p-12 xl:p-20">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg text-lg leading-8 text-gray-400">
              Build your profile, discover opportunities that match your
              skills, and connect with companies looking for talent like you.
            </p>
              ...
              {[
                {
                  ...
                  description: "Find internships, projects and jobs tailored to you.",
                },
                {
                  title: "Showcase your skills",
                  description: "Build a profile that highlights what you can do.",
                },
                {
                  title: "Connect with industry",
                  description: "Get discovered by companies and recruiters.",
                },
              ].map((item) => (
                <div key={item.title} className="flex gap-4">
                  <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-indigo-500/15 border border-indigo-400/20">
                    <svg
        ...
        <section className="flex items-center justify-center px-6 py-12 lg:px-12">
          ...
          <div className="absolute left-6 top-6 flex items-center gap-3 lg:hidden">
            ...
            <span className="font-semibold">SkillSetu</span>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-gray-400">
                Join SkillSetu and start discovering opportunities.
              </p>
            </div>
